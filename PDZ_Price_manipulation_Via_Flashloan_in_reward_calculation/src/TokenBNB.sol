...
contract TOKENbnb is Context, IERC20, Ownable {
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        if (recipient != fee1 && recipient != fee2 && sender != fee1 && sender != fee2) {
    ...
    constructor() {
        ...
        _burnToken = burnToken(0x50F2B2a555e5Fa9E1bb221433DbA2331E8664A69); //主币地址
        emit Transfer(address(0), address(this), _tTotal);
    }

    event IncreaseStaking(address indexed account, uint256 amount, uint256 totalBurn);
    event ArriveFeeRewards(address indexed account, uint256 amount, uint256 totalRewards);
    /**
     */
    event ReceiveReward(address indexed account, uint256 amount, uint256 totalReceive);
